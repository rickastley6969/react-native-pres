			...
			return (
				...
				>
					<Slide transition={["zoom"]} bgColor='primary'>
						...
						<br />
						<br />
						<Heading fontSize='h5'>SENTINELS</Heading>
						<List>
							<ListItem>19IT112 Tarun Kishore</ListItem>
							<ListItem>19IT019 Daya Anand</ListItem>
							<ListItem>19IT027 Eniyan</ListItem>
							<ListItem>19IT055 Manoj</ListItem>
						</List>
					</Slide>
					...
					<Slide transition={["zoom", "fade"]} bgColor='primary'>
						...
						<List>
							<Appear>
								<ListItem>
									Developing phone apps, with React
								</ListItem>
							</Appear>
							<Appear>
								<ListItem>Supports Android, and iOS</ListItem>
							</Appear>
							<Appear>
								<ListItem>
									Truly native - not just a web view
								</ListItem>
							</Appear>
						</List>
					</Slide>
					...
					<Slide transition={["zoom", "fade"]} bgColor='primary'>
						...
						<List>
							<Appear>
								<ListItem>
									A powerful way to construct user interfaces
								</ListItem>
							</Appear>
							<Appear>
								<ListItem>
									Built upon the concept of Components
								</ListItem>
							</Appear>
							<Appear>
								<ListItem>
									A JavaScript library used and developed by
									Facebook
								</ListItem>
							</Appear>
							<Appear>
          ...
          `}
					...
					<Slide transition={["zoom", "fade"]} bgColor='primary'>
						...
						<List>
							<Appear>
								<ListItem>
									Default React Components - View, Text,
									Image, etc
								</ListItem>
							</Appear>
							<Appear>
								<ListItem>
									Style Sheet support, including flexbox
								</ListItem>
							</Appear>
							<Appear>
							...
							<Appear>
								<ListItem>Navigators</ListItem>
							</Appear>
							<Appear>
								<ListItem>XHR / AJAX Support</ListItem>
							</Appear>
						</List>
					</Slide>
...
AppRegistry.registerComponent('AwesomeProject', () => JustifyContentBasics);
          `}
					...
					<Slide transition={["slide"]}>
						...
						<Layout>
							<Fill>
								<Image
									width='75%'
									src={images.reactNativeMaterial1}
								/>
							</Fill>
							<Fill>
								<Image
									width='75%'
									src={images.reactNativeMaterial2}
								/>
							</Fill>
							<Fill>
								<Image
									width='75%'
									src={images.reactNativeMaterial3}
								/>
							</Fill>
						</Layout>
					...
					<Slide transition={["slide"]}>
						<Heading textColor='tertiary'>Networking</Heading>
						<List>
							<Appear>
								<ListItem>New Fetch API Supported</ListItem>
							</Appear>
							<Appear>
								<ListItem>
							...
							<Appear>
								<ListItem>WebSockets Supported</ListItem>
							</Appear>
						</List>
					</Slide>

					<Slide transition={["slide"]}>
						<Heading textColor='tertiary'>Fetch API</Heading>
					...
					<Slide transition={["slide"]}>
						<Text textColor='tertiary'>Getting Started</Text>
					</Slide>
...
`.trim()}
					...
					<Slide transition={["slide"]}>
						<Text textColor='tertiary'>Creating a new project</Text>
					...
					<Slide transition={["slide"]}>
						<FolderStructure>
							<Folder name='AwesomeProject' textColor='tertiary'>
								...
								<File textColor='grey'>index.android.js</File>
								<File textColor='grey'>index.ios.js</File>
							</Folder>
						</FolderStructure>
					</Slide>
...
`.trim()}
					...
					<Slide transition={["slide"]}>
						<Text textColor='tertiary'>Inbuilt Tooling</Text>
						<Image width='35%' src={images.androidMenu} />
					</Slide>

					<Slide transition={["slide"]}>
						<Text textColor='tertiary'>Debug JS Remotely</Text>
						<Image src={images.debugging} />
					</Slide>

					<Slide transition={["slide"]}>
						<Text textColor='tertiary'>Enable Hot Reloading</Text>
						<Image src={images.hotReload} />
					</Slide>

					<Slide transition={["slide"]}>
						<Text textColor='tertiary'>Element Inspector</Text>

						<Image src={images.inspectorCloseup} />
					</Slide>

					<Slide transition={["slide"]}>
						<Text textColor='tertiary'>Network Inspector</Text>

						<Image src={images.networkInspector} />
					</Slide>

					<Slide transition={["slide"]}>
						<Text textColor='tertiary'>Stack Trace</Text>

						<Image width='35%' src={images.stackTrace} />
					</Slide>

					<Slide transition={["slide"]}>
						<Text textColor='tertiary'>Feature Testing</Text>
						...
						<Appear>
							<Text>Remember: It's a real android/ios app!</Text>
						</Appear>
					</Slide>
					...
					<Slide transition={["slide"]}>
						...
						<List>
							<Appear>
								<ListItem>React SnapShot Testing</ListItem>
							</Appear>
							<Appear>
								<ListItem>Built-in Code Coverage</ListItem>
							</Appear>
							<Appear>
								<ListItem>Parallel test runner</ListItem>
							</Appear>
							<Appear>
								<ListItem>
									Mocking functions, imports, network calls
								</ListItem>
							</Appear>
							<Appear>
								<ListItem>Jasmine API</ListItem>
							</Appear>
						</List>
					</Slide>
					...
					<Slide transition={["slide"]}>
						<Text textColor='tertiary'>How it works</Text>

						<Image style={{ margin: 30 }} src={images.howItWorks} />
					</Slide>

					<Slide transition={["slide"]}>
						<Text textColor='tertiary'>Performance</Text>

						<List>
							<Appear>
								<ListItem>
									Animations - Precomputed and Optimised
									natively
								</ListItem>
							</Appear>
							<Appear>
								<ListItem>Reduce re-renders</ListItem>
							</Appear>
							<Appear>
								<ListItem>
									react-native-workers / native
								</ListItem>
							</Appear>
							<Appear>
								<ListItem>Inbuilt performance tooling</ListItem>
							</Appear>
							<Appear>
								<ListItem>
					...
					<Slide transition={["slide"]}>
						<Text textColor='tertiary'>Native Interopability</Text>
						...
						<List>
							...
							<Appear>
								<ListItem>
									Wrap an existing Java/iOS API
								</ListItem>
							</Appear>
							<Appear>
								<ListItem>
									Hybrid Native/React-Native Apps
								</ListItem>
							</Appear>
						</List>
					</Slide>
					...
					<Slide transition={["slide"]} bgColor='primary'>
						<Layout>
							<Table>
								...
								<TableBody>
									<TableRow>
										<TableItem>Bool</TableItem>
										<TableItem>Boolean</TableItem>
									</TableRow>
									<TableRow>
										<TableItem>Number</TableItem>
										<TableItem>Integer</TableItem>
									</TableRow>
									<TableRow>
										<TableItem>Number</TableItem>
										<TableItem>Double</TableItem>
									</TableRow>
									<TableRow>
										<TableItem>Number</TableItem>
										<TableItem>Float</TableItem>
									</TableRow>
									<TableRow>
									...
									<TableRow>
										...
										<TableItem>Callback</TableItem>
									</TableRow>
									<TableRow>
										<TableItem>Object</TableItem>
										<TableItem>ReadableMap</TableItem>
									</TableRow>
									<TableRow>
										<TableItem>Array</TableItem>
										<TableItem>ReadableArray</TableItem>
									</TableRow>
								</TableBody>
							</Table>
						</Layout>
...
`.trim()}
          ...
          `}
					>
						<Text textColor='tertiary'>Navigators</Text>
					...
					<Slide transition={["slide"]}>
						<Text textColor='tertiary'>What's available?</Text>

						<List>
							<Appear>
								<ListItem>Facebook - NavigatorIOS</ListItem>
							</Appear>
							<Appear>
								<ListItem>Facebook - Navigator</ListItem>
							</Appear>
							<Appear>
								<ListItem>
									Facebook - NavigationExperimental
								</ListItem>
							</Appear>
							<Appear>
								<ListItem>
							...
							<Appear>
								<ListItem>
									ReactTraining - react-router (4.0 beta)
								</ListItem>
							</Appear>
							<Appear>
								<ListItem>exponent - ex-navigator</ListItem>
							</Appear>
							<Appear>
								<ListItem>airbnb - Not open sourced</ListItem>
							</Appear>
							<Appear>
								<ListItem>....</ListItem>
							</Appear>
					...
					<Slide transition={["slide"]}>
						<Link
							href='https://www.react-navigation.org'
							textColor='tertiary'
						>
					...
					<Slide transition={["slide"]} bgColor='black'>
						<Heading textColor='white'>Redux</Heading>
					...
					<Slide transition={["slide"]}>
						<Text textColor='tertiary'>Time Travel!</Text>
					</Slide>
					...
					<Slide transition={["slide"]}>
						<Text textColor='tertiary'>Who's using it?</Text>
